            ...
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" action="#" method="POST">
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-sm">
                                    <span onClick={() => navigate('/auth/forgot/password')} className="font-semibold text-indigo-600 hover:text-indigo-500">Forgot
                                        password?</span>
                                </div>
                            </div>
                            <div className="mt-2">
                    ...
                    <p className="mt-10 text-center text-sm/6 text-gray-500">
                        Not a member?
                        <span onClick={() => navigate(ROUTES.SIGNUP)} className="font-semibold text-indigo-600 hover:text-indigo-500"> Register a new Account</span>
                    </p>
                </div>
            </div>
